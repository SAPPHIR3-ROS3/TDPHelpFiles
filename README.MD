...
### se sei qui significa che (comprensibilmente) non vuoi scaricare macchine virtuali di sorta per installare i compilatori di C/C++ per Windows,piccola premessa: tutto il contenuto che scaricherai e installerai tramite pesa pochi MB.
